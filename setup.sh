...
info ""
info "  Firefox:"
info "    1. Open about:debugging#/runtime/this-firefox"
info "    2. Click 'Load Temporary Add-on'"
info "    3. Select: $EXT_FIREFOX/manifest.json"
echo ""
# ────────────────────────────────────────────────────────────────
# Summary
# ────────────────────────────────────────────────────────────────
...
echo -e "  ${YELLOW}⚠${NC} Load extension manually (Chrome or Firefox)"
echo ""
echo -e "  ${CYAN}Next steps:${NC}"
echo -e "   1. Load extension in your browser (see instructions above)"
echo -e "   2. Open runbot.odoo.com"
echo -e "   3. Click '▶ Run locally' on any batch"
echo ""
